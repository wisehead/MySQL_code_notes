...
enum mlog_id_t {
    ...
    /** Type for ncdb page checksum */
    MLOG_NCDB_CHECKSUM = 62,

    /** Type for ncdb lsn check */
    //MLOG_NCDB_LSN_CHECK = 63,

    /** Write trx compensation no. */
    MLOG_TRX_COMP = 64,

    /** Write transaction commited id and no. */
    MLOG_TRX_COMMIT = 65,

    /** Acquire index lock for page split or merge. */
    MLOG_INDEX_LOCK_ACQUIRE = 66,

    /** Server acl cache change */
    MLOG_ACL_CHANGE = 67,

    /** Server sp cache change */
    MLOG_SP_CHANGE = 68,
    ...
    /** Metadata change */
    MLOG_DICT_STATS_UPDATE = 70,

    /** Rtree page discard */
    MLOG_RTREE_PAGE_DISCARD = 71,

    /** Write transaction is commited. */
    MLOG_TRX_CLEAN = 72,

    /** biggest value (used in assertions) */
    MLOG_BIGGEST_TYPE = MLOG_TRX_CLEAN
};
